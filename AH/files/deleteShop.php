...
require_once 'connect.php';
	...
	$stmt = $conn->query("SELECT productName,pid,info,img1,img2,img3,price FROM abedhsen.product where shopId = $shopid;");
	while ($row=$stmt->fetch(PDO::FETCH_ASSOC)){
		$img1 = $row['img1'];
		// echo $img1;
		$img2 = $row['img2'];
		$img3 = $row['img3'];
		$sql = "DELETE FROM abedhsen.product WHERE pid =:c;";
	...
	$sql3 = "DELETE FROM abedhsen.shop WHERE shopId =:c;";
