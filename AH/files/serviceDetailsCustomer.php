...
<?php
	...
	$stmt0 = $conn->query("SELECT serName,shopId,category,baseCharge,img1,img2,info FROM abedhsen.service where serId = $serId;");

	$row0=$stmt0->fetch(PDO::FETCH_ASSOC);
	$shopId = $row0['shopId'];
	$stmtshop = $conn->query("SELECT shopName,shopContact,shopEmail FROM abedhsen.shop where shopId = $shopId;");
